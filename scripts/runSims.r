...
reps <- 1 #Set number of simulations for each combination of budget and location
...
budget <- seq(0,6000000,300000) #Set the budget to spent on at each barrier location
